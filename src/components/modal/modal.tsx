...
export const Modal: FunctionComponent<IModal> = (props) => {
  ...
  return ReactDOM.createPortal(
    <div className={popupStyles.popup}>
      <ModalOverlay
        ref={modalRef}
        closeFunction={(evt: React.MouseEvent<HTMLDivElement>) => {
          closeByClickOverlay(evt);
        }}
      />
      ...
      <div className={popupStyles.modal}>
        <div className={props.modalHeaderStyles}>
          {props.headerText && (
            <h2 className={props.modalStyles}>{props.headerText}</h2>
          )}
          <div className={popupStyles.popup__closeicon}>
