...
export const BurgerIngredients: FunctionComponent = () => {
  ...
  function determineElementPosition(e: React.ChangeEvent<HTMLDivElement>) {
    ...
    const positionOfSouceContainer =
      soucesRef.current !== null && soucesRef.current.offsetTop;
    const positionofFillingsContainer =
      fillingsRef.current !== null && fillingsRef.current.offsetTop;
  ...
  return (
    <div className={ingredientsStyles.burger__tabs}>
      ...
      <div
        className={ingredientsStyles.burger__ingredients}
        onScroll={(e: any) => {
          determineElementPosition(e);
        }}
      >
        <IngredientType
