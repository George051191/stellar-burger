          ...
          <>
            <Route path="/feed/:id">
              <Modal
                ...
                modalStyles={`text text_type_digits-default`}
                modalHeaderStyles={`${styles.modal__header} mt-10 mr-10 ml-10`}
                closeModal={() => {
                  history.goBack();
                  dispatch({ type: CLICK_ON_CLOSE_BUTTON });
                }}
              >
                {" "}
                <OrderStuff />
        ...
        {background && (
          <Route path="/ingredients/:id">
            <Modal
              ...
              modalStyles={`text text_type_main-large`}
              modalHeaderStyles={`${styles.modal__header} mt-10 mr-10 ml-10`}
              closeModal={() => {
                history.goBack();
                dispatch({ type: CLICK_ON_CLOSE_BUTTON });
