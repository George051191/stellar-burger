...
import { refreshUser } from "../../services/actions/user-data";
...
export const FormElement: FunctionComponent = () => {
  const { formName, formEmail, formPassword, userName, userEmail } =
    ...
    <div className={styles.formelement}>
      <form
        ...
        onSubmit={(e) => {
          e.preventDefault();
          dispatch(
            refreshUser(formEmail, formPassword, formName, getCookie("token"))
          );
        }}
      >
