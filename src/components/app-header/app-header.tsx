        ...
        <ul className={headerStyles.header__list}>
          <Link to="/" className={headerStyles.link}>
            <MenuItem
              ...
              textStyles={
                isActivePage("/")
                  ? `${headerStyles.activenavlink} text text_type_main-default ml-2`
                  : `text text_type_main-default ml-2 ${headerStyles.navlink}`
              }
              styles={`${headerStyles.header__item} pl-5 pr-5`}
            >
          ...
          <Link to="/feed" className={headerStyles.link}>
            <MenuItem
              text="Лента заказов"
              textStyles={
                isActivePage("/feed") || location.pathname.indexOf("feed") > -1
                  ? `${headerStyles.activenavlink} text text_type_main-default ml-2`
                  : `text text_type_main-default ml-2 ${headerStyles.navlink}`
              }
              styles={`${headerStyles.header__item} pl-5 pr-5`}
